...
function App() {
  ...
  const saveDataToBackend = async () => {
    if (!userId) return;
    try {
      await fetch('https://habittrack-back-okf65sfdm-adiths-projects-6dd5238c.vercel.app/api/savedata', {
        method: 'POST',
  ...
  const deleteTask = async (taskIndex) => {
    ...
    try {
      await fetch('https://habittrack-back-okf65sfdm-adiths-projects-6dd5238c.vercel.app/api/deletetask', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
